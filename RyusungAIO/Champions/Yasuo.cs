...
using SpellDatabase = RyusungAIO.Evade.SpellDatabase;
using SafePathResult = RyusungAIO.Evade.SafePathResult;
using SkillshotDetector = RyusungAIO.Evade.SkillshotDetector;
using Skillshot = RyusungAIO.Evade.Skillshot;
using FoundIntersection = RyusungAIO.Evade.FoundIntersection;
using EvadeManager = RyusungAIO.Evade.EvadeManager;
using DetectionType = RyusungAIO.Evade.DetectionType;
using CollisionObjectTypes = RyusungAIO.Evade.CollisionObjectTypes;
    ...
    Interrupter.InterruptSpellArgs args
        ...
        public class EvadeSkillshot
        {
            ...
            public static void Init(Menu menu)
            {
                ...
                RyusungAIO.Evade.Collision.Init();
