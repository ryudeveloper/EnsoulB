...
using System.Linq;
using static RyusungAIO.Champions.GetTargets;
using static RyusungAIO.Champions.Combos;
using static RyusungAIO.Champions.Fiora;
using static RyusungAIO.Champions.FioraPassive;
using static RyusungAIO.Champions.MathAndExtensions;
...
namespace RyusungAIO.Champions
{
            ...
            foreach (var spellData in spellDatas)
            {
                ...
                if (spellData.CharacterName == "Azir" && spellData.Slot == SpellSlot.R && args.Slot == SpellSlot.R)// chua test
                {
                    ...
                    float width = caster.Level >= 16 ? 125 * 6 / 2 :
                                ...
                                125 * 4 / 2;
                     RyusungAIO.Helpers.Evade.Geometry.Rectangle Rect = new  RyusungAIO.Helpers.Evade.Geometry.Rectangle(start, end, width);
    ...
    AIBaseClientProcessSpellCastEventArgs args
        ...
        public Fiora()
        {
            ...
            {
                //RyusungAIO.Evade.EvadeManager.Attach();
                //Evade.Evade.Init();
                EvadeTarget.Init();
