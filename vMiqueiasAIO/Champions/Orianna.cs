...
namespace vMiqueiasAIO.Champions
{
    static class Orianna
    {
        ...
        public static void initOrianna()
        {
            ...
            Notifications.Add(new Notification("vMiqueias AIO fuck WWapper", "Orianna credits Kortatu and XSalice"));
            ...
            Game.Print("<font color=\"#FF9900\"><b>DH.Oriana:</b></font> Feedback send to facebook yts.1996 vMiqueias");
