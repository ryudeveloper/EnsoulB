        ...
        private static readonly string[] Jungleminions =
{
        ...
        public Nidalee()
        {
            Notifications.Add(new Notification("vMiqueias AIO fuck WWapper", "Nidalee credit Kurisu"));
        ...
        private static void NidaMenu()
        {
            ...
            _mainMenu.Attach();
            Game.Print("<font color=\"#FF9900\"><b>DH.Nidalee:</b></font> Anything feedback send to facebook yts.1996 vMiqueias");
