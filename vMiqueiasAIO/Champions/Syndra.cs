...
namespace vMiqueiasAIO.Champions
{
    class Syndra
    {
        ...
        public Syndra()
        {
            Notifications.Add(new Notification("vMiqueias AIO fuck WWapper", "Syndra credit Kortatu"));
            ...
            Game.Print("<font color=\"#FF9900\"><b>DH.Syndra:</b></font> Feedback send to facebook yts.1996 vMiqueias");
