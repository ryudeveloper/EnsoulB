...
using System.Linq;
using static vMiqueiasAIO.Champions.GetTargets;
using static vMiqueiasAIO.Champions.Combos;
using static vMiqueiasAIO.Champions.Fiora;
using static vMiqueiasAIO.Champions.FioraPassive;
using static vMiqueiasAIO.Champions.MathAndExtensions;
...
namespace vMiqueiasAIO.Champions
{
            ...
            foreach (var spellData in spellDatas)
            {
                ...
                if (spellData.CharacterName == "Azir" && spellData.Slot == SpellSlot.R && args.Slot == SpellSlot.R)// chua test
                {
                    ...
                    float width = caster.Level >= 16 ? 125 * 6 / 2 :
                                ...
                                125 * 4 / 2;
                     vMiqueiasAIO.Helpers.Evade.Geometry.Rectangle Rect = new  vMiqueiasAIO.Helpers.Evade.Geometry.Rectangle(start, end, width);
    ...
    AIBaseClientProcessSpellCastEventArgs args
        ...
        public Fiora()
        {
            ...
            {
                //vMiqueiasAIO.Evade.EvadeManager.Attach();
                //Evade.Evade.Init();
                EvadeTarget.Init();
