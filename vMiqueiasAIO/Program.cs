...
using vMiqueiasAIO.Champions;
using vMiqueiasAIO.Helpers;
using EnsoulSharp;
using EnsoulSharp.SDK;
using EnsoulSharp.SDK.MenuUI;
using EnsoulSharp.SDK.MenuUI.Values;
using Activator = vMiqueiasAIO.Plugins.Activator;

namespace vMiqueiasAIO
{
    internal class Program
    {
        ...
        private static void OnGameLoad()
        {
            try
            {
                ...
                //var type = Type.GetType("vMiqueiasAIO.Champions." + player.CharacterName);
                //Game.Print("Loading1");
                //if (type != null)
                //{
                //    Game.Print("Loading");
                ...
                //{
                //    Game.Print("Loading2");
                //    var common = Type.GetType("vMiqueiasAIO.Champions." + "Other");
                //    if (common != null)
                //    {
                //        Game.Print("Loading3");
