...
namespace vMiqueiasAIO.Champions
{
    class Renekton
    {
        ...
        public Renekton()
        {
            Notifications.Add(new Notification("vMiqueias AIO fuck WWapper", "Renekton credits Soresu and Exory"));
            InitRenekton();
            InitMenu();

            Game.Print("<font color=\"#05FAAC\"><b>DH.Renekton:</b></font> Feedback send to facebook yts.1996 vMiqueias");
