        ...
        static SpellDatabase()
        {
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    CanBeRemoved = true,
                    FromObjects = new[] { "Ekko_Base_R_TrailEnd" }
                });
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    ExtraMissileNames = new[] { "EzrealQPulseMissile" },
                    CanBeRemoved = true,
                    CollisionObjects =
                        new[]
                        {CollisionObjectTypes.Champions, CollisionObjectTypes.Minion, CollisionObjectTypes.YasuoWall},
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    DangerValue = 3,
                    IsDangerous = true,
                    MissileSpellName = "EzrealRBarrage",
                    CollisionObjects = new[] { CollisionObjectTypes.YasuoWall },
                    Id = 245,
                });
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    SourceObjectName = "w_dissonance_ball" //Orianna_Base_W_Dissonance_ball_green & Orianna_Base_W_Dissonance_cas_green
                });
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    FromObject = "yomu_ring_",
                    SourceObjectName = "r_vacuumindicator", //Orianna_Base_R_VacuumIndicator
                });
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    //FromObjects = new[] { "Zed_Clone_idle", "Zed_Clone_Idle" },
                    FromObjects = new[] { "Zed_Base_W_tar", "Zed_Base_W_cloneswap_buf" },
                    CollisionObjects = new[] { CollisionObjectTypes.YasuoWall },
                });
