...
namespace vMiqueiasAIO.Champions
{
    class Jayce
    {
        ...
        public Jayce()
        {
            Notifications.Add(new Notification("vMiqueias AIO fuck WWapper", "Jayce credit  Detusk"));
            ...
            try
            {
                ...
                Game.Print("<font color=\"#05FAAC\"><b>DH.Jayce:</b></font> Feedback send to facebook yts.1996 vMiqueias");
        ...
        private static void castQEPred(AIHeroClient target)
        {
            ...
            else if (po.Hitchance == HitChance.Collision && Jayce.Config["extra"].GetValue<MenuBool>("useMunions"))
            {
        ...
        private static bool shootQE(Vector3 pos, bool man = false)
        {
            try
            {
                ...
                if (Jayce.Config["extra"].GetValue<MenuBool>("packets"))
                {
        ...
        {
            if (Jayce.Config["combo"].GetValue<MenuBool>("parlelE"))
            {
        ...
        {
            if (!Jayce.Config["combo"].GetValue<MenuBool>("hammerKill") || target == null)
                return false;
