...
namespace vMiqueiasAIO.Champions
{
    class Velkoz
    {
        ...
        public Velkoz()
        {
            ...
            Notifications.Add(new Notification("vMiqueias AIO fuck WWapper", "Velkoz credit Kortatu"));
            ...
            Game.Print("<font color=\"#FF9900\"><b>DH.Velkoz:</b></font> Feedback send to facebook yts.1996 vMiqueias");
