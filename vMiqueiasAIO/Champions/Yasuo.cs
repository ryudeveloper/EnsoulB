...
using vMiqueiasAIO.Helpers;
using System.Text.RegularExpressions;
using SpellDatabase = vMiqueiasAIO.Evade.SpellDatabase;
using SafePathResult = vMiqueiasAIO.Evade.SafePathResult;
using SkillshotDetector = vMiqueiasAIO.Evade.SkillshotDetector;
using Skillshot = vMiqueiasAIO.Evade.Skillshot;
using FoundIntersection = vMiqueiasAIO.Evade.FoundIntersection;
using EvadeManager = vMiqueiasAIO.Evade.EvadeManager;
using DetectionType = vMiqueiasAIO.Evade.DetectionType;
using CollisionObjectTypes = vMiqueiasAIO.Evade.CollisionObjectTypes;
using MinionTeam = SPrediction.MinionManager.MinionTeam;
using MinionOrderTypes = SPrediction.MinionManager.MinionOrderTypes;

namespace vMiqueiasAIO.Champions
{
    class Yasuo
    {
        #region Constants
    ...
    Interrupter.InterruptSpellArgs args
        ...
        public class EvadeSkillshot
        {
            ...
            public static void Init(Menu menu)
            {
                ...
                vMiqueiasAIO.Evade.Collision.Init();
